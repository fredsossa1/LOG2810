...
public class GrapheOriente {
	...
	{
		int TAILLE_MAX_INGREDIENTS =23;
		int TAILLE_MAX_ARCS = 23;
		
		ingredients_  = new Ingredient [TAILLE_MAX_INGREDIENTS] ;
		
			
				
				matrice_ = new int [23][23];
				FileInputStream ips = new FileInputStream(nomFichier);
	...
	private int nbChemins_=0;
	 List<String> listeChemins_ = new LinkedList<String>();
